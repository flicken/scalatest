 ...
 */
private[scalatest] trait PureMatchers extends Assertions with Tolerance with ShouldVerb with MatcherWords with Explicitly { matchers =>
...
*/
  ...
  sealed class ResultOfNotWordForCollectedAny[T](collected: Collected, xs: scala.collection.GenTraversable[T], original: Any, willBeTrue: Boolean) {
    ...
    /**
     * <strong>
     * The will be === syntax has been deprecated and will be removed in a future version of ScalaTest. Please use will equal, will ===, willEqual,
...
*/
  ...
  sealed class AnyWillWrapper[T](val leftSideValue: T) {
     ...
     * </pre>
     */
    def will[TYPECLASS1[_], TYPECLASS2[_]](rightMatcherFactory2: MatcherFactory2[T, TYPECLASS1, TYPECLASS2])(implicit typeClass1: TYPECLASS1[T], typeClass2: TYPECLASS2[T]): Fact = {
     ...
     * </pre>
     */
    def will[TYPECLASS1[_], TYPECLASS2[_], TYPECLASS3[_]](rightMatcherFactory3: MatcherFactory3[T, TYPECLASS1, TYPECLASS2, TYPECLASS3])(implicit typeClass1: TYPECLASS1[T], typeClass2: TYPECLASS2[T], typeClass3: TYPECLASS3[T]): Fact = {
     ...
     * </pre>
     */
    def will[TYPECLASS1[_], TYPECLASS2[_], TYPECLASS3[_], TYPECLASS4[_]](rightMatcherFactory4: MatcherFactory4[T, TYPECLASS1, TYPECLASS2, TYPECLASS3, TYPECLASS4])(implicit typeClass1: TYPECLASS1[T], typeClass2: TYPECLASS2[T], typeClass3: TYPECLASS3[T], typeClass4: TYPECLASS4[T]): Fact = {
     ...
     * </pre>
     */
    def will[TYPECLASS1[_], TYPECLASS2[_], TYPECLASS3[_], TYPECLASS4[_], TYPECLASS5[_], TYPECLASS6[_]](rightMatcherFactory6: MatcherFactory6[T, TYPECLASS1, TYPECLASS2, TYPECLASS3, TYPECLASS4, TYPECLASS5, TYPECLASS6])(implicit typeClass1: TYPECLASS1[T], typeClass2: TYPECLASS2[T], typeClass3: TYPECLASS3[T], typeClass4: TYPECLASS4[T], typeClass5: TYPECLASS5[T], typeClass6: TYPECLASS6[T]): Fact = {
     ...
     * </pre>
     */
    def will[TYPECLASS1[_], TYPECLASS2[_], TYPECLASS3[_], TYPECLASS4[_], TYPECLASS5[_], TYPECLASS6[_], TYPECLASS7[_]](rightMatcherFactory7: MatcherFactory7[T, TYPECLASS1, TYPECLASS2, TYPECLASS3, TYPECLASS4, TYPECLASS5, TYPECLASS6, TYPECLASS7])(implicit typeClass1: TYPECLASS1[T], typeClass2: TYPECLASS2[T], typeClass3: TYPECLASS3[T], typeClass4: TYPECLASS4[T], typeClass5: TYPECLASS5[T], typeClass6: TYPECLASS6[T], typeClass7: TYPECLASS7[T]): Fact = {
     ...
     * </pre>
     */
    def will[TYPECLASS1[_], TYPECLASS2[_], TYPECLASS3[_], TYPECLASS4[_], TYPECLASS5[_], TYPECLASS6[_], TYPECLASS7[_], TYPECLASS8[_]](rightMatcherFactory8: MatcherFactory8[T, TYPECLASS1, TYPECLASS2, TYPECLASS3, TYPECLASS4, TYPECLASS5, TYPECLASS6, TYPECLASS7, TYPECLASS8])(implicit typeClass1: TYPECLASS1[T], typeClass2: TYPECLASS2[T], typeClass3: TYPECLASS3[T], typeClass4: TYPECLASS4[T], typeClass5: TYPECLASS5[T], typeClass6: TYPECLASS6[T], typeClass7: TYPECLASS7[T], typeClass8: TYPECLASS8[T]): Fact = {
     ...
     * </pre>
     */
    def will[TYPECLASS1[_], TYPECLASS2[_], TYPECLASS3[_], TYPECLASS4[_], TYPECLASS5[_], TYPECLASS6[_], TYPECLASS7[_], TYPECLASS8[_], TYPECLASS9[_]](rightMatcherFactory9: MatcherFactory9[T, TYPECLASS1, TYPECLASS2, TYPECLASS3, TYPECLASS4, TYPECLASS5, TYPECLASS6, TYPECLASS7, TYPECLASS8, TYPECLASS9])(implicit typeClass1: TYPECLASS1[T], typeClass2: TYPECLASS2[T], typeClass3: TYPECLASS3[T], typeClass4: TYPECLASS4[T], typeClass5: TYPECLASS5[T], typeClass6: TYPECLASS6[T], typeClass7: TYPECLASS7[T], typeClass8: TYPECLASS8[T], typeClass9: TYPECLASS9[T]): Fact = {
...
*/
   ...
   * to enable <code>will</code> methods to be invokable on that object.
   */
  implicit override def convertToStringShouldWrapper(o: String): StringWillWrapper = new StringWillWrapper(o)
